...
g_gender <- grid.arrange(nice_bar_plot(gender_na_rm$Gender, "What's your gender?", 11, 1))
...
g_city_pop <- grid.arrange(nice_bar_plot(city_pop_na_rm$CityPopulation, "About how many people live in your city?", 11, 0))
