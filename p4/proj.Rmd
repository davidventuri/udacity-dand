...
g_age_log10 <-
  grid.arrange(nice_histogram((fcc_data$Age + 0.01), 0.02, "Age (Log10)") +
...
nice_boxplot <- function(df, xlab, ylab, questions) {
  ...
  if (ylab == "ExpectedEarning (Log10) (thousands)" | ylab == "Income (Log10) (thousands)") {
...
g_hours_learn_continent <-
  grid.arrange(nice_boxplot(select(fcc, ContinentCitizen, HoursLearning),
                            "ContinentCitizen", "HoursLearning (Log10)") +
               coord_trans(y = "log10", limy = c(1, 110)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80)),
...
g_exp_earn_gender <-
  grid.arrange(nice_boxplot(select(fcc, Gender, ExpectedEarning),
                            "Gender", "ExpectedEarning (Log10) (thousands)") +
...
g_exp_earn_continent <-
  grid.arrange(nice_boxplot(select(fcc, ContinentCitizen, ExpectedEarning),
                            "ContinentCitizen", "ExpectedEarning (Log10) (thousands)") +
               coord_trans(y = "log10", limy = c(5, 210)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80, 160)),
...
g_exp_earn_hours_learning <-
  grid.arrange(nice_boxplot(select(fcc, HoursLearningBucket,
                                   ExpectedEarning),
                            "HoursLearning", "ExpectedEarning (Log10) (thousands)") +
               coord_trans(y = "log10", limy = c(5, 210)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80, 160)),
...
g_months_prog_job_int <-
  grid.arrange(nice_boxplot(years_prog_job_lim,
                            "JobRoleInterest", "YearsProgramming (Log10)") +
...
g_hours_learn_job_int <-
  grid.arrange(nice_boxplot(select(fcc_job_lim, JobRoleInterest, HoursLearning),
                            "JobRoleInterest", "HoursLearning (Log10)") +
               coord_trans(y = "log10", limy = c(1, 110)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80)),
...
g_income_job_int <-
  grid.arrange(nice_boxplot(select(fcc_job_lim, JobRoleInterest, Income),
                            "JobRoleInterest", "Income (Log10) (thousands)") +
               coord_trans(y = "log10", limy = c(5, 210)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80, 160)),
...
g_exp_earn_job_int <-
  grid.arrange(nice_boxplot(select(fcc_job_lim, JobRoleInterest, ExpectedEarning),
                            "JobRoleInterest", "ExpectedEarning (Log10) (thousands)") +
               coord_trans(y = "log10", limy = c(5, 210)) +
               scale_y_continuous(breaks = c(5, 10, 20, 40, 80, 160)),
