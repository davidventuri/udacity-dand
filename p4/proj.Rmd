...
g_gender <- grid.arrange(nice_bar_plot(fcc_data$Gender, "What is your gender?", 11, 1))
...
g_school_degree <- grid.arrange(nice_bar_plot(fcc_data$SchoolDegree, "What is the highest level of school you have completed?", 5.7, 5))
...
g_school_major <- grid.arrange(nice_bar_plot(droplevels(school_major_na_rm_lim$SchoolMajor), "What was the main subject you studied in university?", 3, 0, nrow(school_major_na_rm)))
